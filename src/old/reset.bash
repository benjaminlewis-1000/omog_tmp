...
# Script to backup the keyframes (images) and their respective databases. 
# Presupposes several things, namely database names, image save 
# directory, database user name, and keyframe table name.
# Function is to zip up all images, where they exist, and save off
# the corresponding database. If the directory of images is empty,
# it skips that directory and saves nothing from it. All saved information
# is saved in the backup directory, and the image directories are wiped clean. 
